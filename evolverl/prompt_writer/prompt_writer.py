"""
Prompt Writer module for the AERL framework.

This module implements evolutionary prompt generation and mutation as described
in the technical paper, enabling systematic prompt optimization.
"""
