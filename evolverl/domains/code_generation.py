"""
Code generation domain implementation for EvolveRL.
"""
...
class CodeAdversarialTester(AdversarialTester):
    ...
    def _generate_single_test(self, difficulty: float) -> AdversarialTestCase:
    ...
    def _generate_simple_test(self) -> AdversarialTestCase:
    ...
    def _generate_medium_test(self) -> AdversarialTestCase:
    ...
    def _generate_hard_test(self) -> AdversarialTestCase:
...
class CodeEvaluator:
    ...
    def evaluate_correctness(self, test_case: AdversarialTestCase, response: str) -> float:
    ...
    def evaluate_efficiency(self, test_case: AdversarialTestCase, response: str) -> float:
